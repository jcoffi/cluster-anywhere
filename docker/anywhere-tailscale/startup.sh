...
if [ "$NODETYPE" = "head" ]; then
  ...
  ray start --address='nexus.chimp-beta.ts.net:6379' --resources='{"'"$LOCATION"'": 1}' --num-cpus=0 --disable-usage-stats --dashboard-host 0.0.0.0 --node-ip-address $HOSTNAME.chimp-beta.ts.net --node-name $HOSTNAME.chimp-beta.ts.net
